                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-3 mb-3">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Input Penduduk Baru</h3>
                                </div>
                                <div class="card-body">
                                    <form id="myForm">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="lahir" type="date"
        ...
        document.getElementById('myForm').addEventListener('submit', function(event) {
            ...
            fetch('https://api-group4-prognet.manpits.xyz/api/Penduduk', {
                ...
                .then(existingData => {
                    ...
                    const nikExists = existingData.some(penduduk => {
                        return penduduk.nik === nikValue;
                    });

                    if (nikExists) {
                        // Handle the case where the NIK already exists
                        alert('NIK Sudah Ada! Gunakan NIK Baru!');
                    } else {
                        // If NIK doesn't exist, continue to submit the form data
